...
- **`fix_year`** in `rules/run.smk` silently maps any `day >= 2025` to its 2024 equivalent for input lookup. Future-network runs depend on this; don't be surprised when 2024 base files are read for a 2025 day.
